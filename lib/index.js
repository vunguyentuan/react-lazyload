...
var LazyLoad = (function (_Component) {
  ...
  LazyLoad.prototype.render = function render() {
    return this.visible ? this.props.children : this.props.placeholder ? this.props.placeholder : _react2['default'].createElement('div', { style: { height: this.props.height }, className: this.props.className });
  };
